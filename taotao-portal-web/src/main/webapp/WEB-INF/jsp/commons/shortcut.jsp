...
<div id="shortcut-2013">
	<div class="w">
		...
		<ul class="fr lh">
			<c:choose>
				<c:when test="${not empty result.userName}">${result.userName} + "，欢迎来到淘淘！<a href="http://localhost:8088/user/logout/${token}" class=\"link-logout\">[退出]</a></c:when>
				<c:otherwise><li class="fore1" id="loginbar" clstag="homepage|keycount|home2013|01b">！欢迎来到淘淘！<a href="javascript:login()">[登录]</a>&nbsp;<a href="javascript:regist()">[免费注册]</a></li>
				</c:otherwise>
			</c:choose>
