...
<div id="o-header-2013">
	<div class="w" id="header-2013">
		...
		<div id="settleup-2013" clstag="homepage|keycount|home2013|05a">
			<dl>
				<dt class="ld"><s></s><span class="shopping"><span id="shopping-amount"></span></span><a href="javascript:goCart();" id="settleup-url">去购物车结算</a> <b></b> </dt>
<!-- 				<dd>
					<div class="prompt">
						<div class="loading-style1"><b></b>加载中，请稍候...</div>
					</div>
...
<script type="text/javascript">
	function goCart() {
        ...
        window.location.href="http://localhost:8089/cart/cart.html"
